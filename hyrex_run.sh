...
export HyREX_DIR=/home/xulei/HyREX
...
export TRACE_FILE=$OUT_DIR/trace.txt

export LIB_DIR=$HyREX_DIR/lib

export TRAIN_DATA_FULL="-train  $DATA_HOME/train"
export TRAIN_DATA_PARSED="-trainParse $DATA_HOME/train.parsed"

export HELDOUT_DATA_FULL="-test  $DATA_HOME/test"
export HELDOUT_DATA_PARSED="-testParse $DATA_HOME/test.parsed"

export TEST_DATA_FULL="-test  $DATA_HOME/test"
export TEST_DATA_PARSED="-testParse $DATA_HOME/test.parsed"
...
export JVM_ARGS="-Xmx1024m  -cp ./bin:$LIB_DIR/jsre.jar:$LIB_DIR/log4j-1.2.8.jar:$LIB_DIR/commons-digester.jar:$LIB_DIR/commons-collections.jar:$LIB_DIR/commons-logging.jar:$LIB_DIR/commons-beanutils.jar:$LIB_DIR/jutil.jar:$LIB_DIR/libsvm.jar:$LIB_DIR/bioRelEx.jar:$LIB_DIR/stanford-parser-2012-03-09-models.jar:$LIB_DIR/stanford-parser.jar"

rm -rf $OUT_DIR/*
#rm -rf $CROSS_FOLD/*
rm -rf $HyREX_DIR/tmp/*
rm $SVM_LIGHT_TK/svm_predictions
...
cd $HyREX_DIR
read -n1 -p "Press any key to continue...To Run TKOutputGenerator"
...
echo "                         first in                  "
echo "!!!!!!!!!!!!!!!!!!!!!!!!!fnExp!!!!!!!!!!!!!!!!!!!!!"
read -n1 -p "Press any key to continue...To Run fnExp"
fnExp
